	...
	struct inode *inode)
{
	...
	rc = copy_mc_to_kernel(&fake_pi, addr,
...
extern int nova_notify_change(struct user_namespace *userns,
			struct dentry *dentry, struct iattr *attr);
extern int nova_getattr(struct user_namespace *userns, const struct path *path,
