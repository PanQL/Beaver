...
static bool __ovl_set_folio_dirty_no_writeback(struct address_space *mapping,
						struct folio *folio)
{
...
static const struct address_space_operations ovl_aops = {
	...
	.write_begin	= simple_write_begin,
	.write_end	= simple_write_end,
	.dirty_folio	= __ovl_set_folio_dirty_no_writeback,
	.direct_IO = noop_direct_IO,
};
...
static void ovl_fill_inode(struct user_namespace *userns,
...
// #endif
	...
	inode_init_owner(userns, inode, NULL, S_IFDIR | S_IRWXU);
...
struct inode *pcache_get_inode(struct user_namespace *userns, struct super_block *sb,
